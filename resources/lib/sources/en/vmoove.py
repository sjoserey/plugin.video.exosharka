...
class source:
    def __init__(self):
        self.priority = 0
        self.language = ['en']
        self.domains = ['vmovee.xyz']
        self.base_link = 'https://vmovee.xyz'
        self.search_link = '/?gold=search&sub_gold=&sub2_gold=&q=%s'
        self.search_episode_link = '/gold-app/gold-includes/GOLD.php?season_id=%s'
        self.episode_link = '/gold-app/gold-includes/GOLD.php?episode_id=%s'
