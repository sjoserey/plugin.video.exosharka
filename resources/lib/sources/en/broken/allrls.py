...
class source:
    def __init__(self):
        self.priority = 0
        self.language = ['en']
        self.domain = 'bestrls.net'
        self.base_link = 'http://bestrls.net'
        self.search_link = 'http://bestrls.net/?s='
        self.headers = {'Referer':'http://bestrls.net/','User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Safari/537.36'}
